...
public class SQLConstants {
    ...
    public static final String CREATE_EVENT_ENTRY_TABLE = "CREATE TABLE EVENT_ENTRY (EVENT_ID INTEGER PRIMARY KEY AUTOINCREMENT, " +
            "EVENT_NAME VARCHAR(20), EVENT_TYPE INTEGER, EVENT_DESC VARCHAR(20),EVENT_COMMENT VARCHAR(100), EVENT_ATTACHMENT VARCHAR(100), START_TIME DATETIME, END_TIME DATETIME);";
    ...
    public static final String CREATE_LOCATION_DATA = "CREATE TABLE LOCATION_DATA(LOCATION VARCHAR(200), LOCATION_TIME DATETIME);";
    ...
    public static final String DELETE_LOCATION_DATA = "DROP TABLE IF EXISTS LOCATION_DATA";
